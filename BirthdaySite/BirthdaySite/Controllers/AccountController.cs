...
namespace BirthdaySite.Controllers
{
    ...
    {
        private ISignInManagerService signInManagerService;
        ...
        public async Task<ActionResult> Login(LoginViewModel model, string returnUrl)
        {
            ...
            var result = await this.signInManagerService.PasswordSignInAsync(model.Email, model.Password, model.RememberMe, shouldLockout: false);
            switch (result)
            {
        ...
        public async Task<ActionResult> Register(RegisterViewModel model)
        {
            if (ModelState.IsValid)
            {
                ...
                if (result.Succeeded)
                {
                    await this.signInManagerService.SignInAsync(user, isPersistent:false, rememberBrowser:false);
